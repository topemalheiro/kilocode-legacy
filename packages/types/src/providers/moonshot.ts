...
export const moonshotModels = {
	...
	"kimi-k2.6": {
		...
		defaultTemperature: 0.6,
		description:
			"Kimi K2.6 is the latest generation of Moonshot AI's Kimi series, featuring improved reasoning capabilities and enhanced performance across diverse tasks.",
	},
	// kilocode_change end
